...
notify-send -t 500 --icon="nvidia" "GPU-Recorder" "Recording started" 	
...
cd $location
if ls -f "$filename";
then notify-send -t 500 --icon="nvidia" "GPU-Recorder" "Recording finished";
else notify-send -t 500 --icon=error "Error" "Failed to Create the file";
fi
